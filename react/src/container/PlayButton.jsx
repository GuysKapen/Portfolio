...
const PlayButton = () => {
    return (
        <a href={"https://github.com/GuysRGithub"} >
            <div className="flex w-48 h-14 bg-white text-gray-800 rounded-lg items-center justify-center">
                <div className="mr-3">
                ...
                <div>
                    <div className='text-gray-800 font-bold'>Follow Github</div>
                </div>
            </div>
        </a>
    );
